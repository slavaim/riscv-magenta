...
Below is an output for a system booting with a user process that does some chores and terminates. The system panics as the last user process terminated.
